...
/**
 * 测试springboot+springjdbc+mybatis多数据源
...
public class MoreDataServiceImplTest extends BaseTest {
    ...
    public void test() {
        ...
        bookRepository.insertBook(new Book(1, "三国演义", "罗贯中"));
        bookRepository.insertBook(new Book(2, "红楼梦", "曹雪芹"));
        List<Book> bookList = bookRepository.selectBookList();
        System.out.println(bookList);
        bookRepository.updateBook(new Book(1, "三国演义2", "罗贯中2"));
        bookList = bookRepository.selectBookList();
        System.out.println(bookList);
    }
