...
/**
 * Created by shucheng on 2020/8/21 22:18
...
public class ConditionalOnClassIntegrationTest {
    ...
    public void whenDependentClassIsPresent_thenBeanCreated() {
        this.contextRunner.withUserConfiguration(ConditionalOnClassConfiguration.class)
                .run(context -> {
                    ...
                    assertThat(context).hasSingleBean(ConditionalOnClassConfiguration.class);
    ...
    public void whenDependentClassIsNotPresent_thenBeanMissing() {
        this.contextRunner.withUserConfiguration(ConditionalOnClassConfiguration.class)
                ...
                .run(context -> {
                    ...
                    assertThat(context).doesNotHaveBean(ConditionalOnClassConfiguration.class);
                });
    }
    ...
    public void whenDependentClassIsNotPresent_thenBeanCreated() {
        this.contextRunner.withUserConfiguration(ConditionalOnMissingClassConfiguration.class)
                ...
                .run(context -> {
                    ...
                    assertThat(context).hasSingleBean(ConditionalOnMissingClassConfiguration.class);
                });
    }

    @Configuration
    @ConditionalOnClass(ConditionalOnClassIntegrationTest.class)
    public static class ConditionalOnClassConfiguration {
        @Bean
    ...
    @Configuration
    @ConditionalOnMissingClass("com.kittycoder.ConditionalOnClassIntegrationTest")
    public static class ConditionalOnMissingClassConfiguration {
        @Bean
